exports.text = 
    [
         ...
         'Early hockey games allowed as many as 30 players a side on the ice', 'Most fleas do not live past a year old',
         ...
         'The decomposition point of Olive Oil is 220 degrees Celsius', 'Ten radishes only contain eight calories',
         ...
         'One female mouse can produce up to 100 babies a year', 'Impotence is grounds for divorce in 26 U.S. states',
         ...
         'People with darker skin will not wrinkle as fast as people with lighter skin', 'Fido means faithful in Latin',
         'Pebbles cereal was actually named after the shape of the cereal and not the Pebbles Flintstone character',
         'A group of kangaroos is called a mob', "Cat's urine glows under a blacklight.",
         'Every three seconds, a new baby is born',
         'More than 260,000 people have been killed by volcanic activity since 1700 AD.',
         'The only predator that polar bears have are humans', 'Many insects can carry 50 times their own body weight',
         ...
         'Crayola Crayons currently has over 120 different crayon colours', 'Odontophobia is the fear of teeth',
         ...
         'Almonds are members of the peach family', 'The oldest known disease in the world is leprosy',
         'A fall of 30 feet can be survived my most cats', 'The largest member of the dolphin family are orcas',
         ...
         'Every person has a unique tongue print', 'Hair will fall out faster on a person that is on a crash diet',
         'In 1890, there was no sunshine for the whole month of December in Westminster in London.',
         'Charles Darwin spent 39 years studying earthworms', 'The Boeing 737 is nicknamed the Fat Albert',
         ...
         'An octopus has three hearts', 'Roses generally need around 6 hours of sunlight to grow properly.',
         ...
         'Bats always turn left when exiting a cave', 'Penguins can jump as high as 6 feet in the air',
         ...
         'Finland has 187,888 lakes and 179,584 islands', 'The average adult has approximately six pounds of skin',
         ...
         'The Dead Sea has been sinking for last several years', 'Uranus has 27 moons',
         ...
         'Some desert snails have been known to sleep for three to four years', 'Over 80% of the brain is water',
         ...
         'Milk and cheese can aid in the reduction of tooth decay', 'On average, a strawberry has 200 seeds on it',
         ...
         'Eating a banana at night can help in falling asleep', 'The stapler was invented in Spring Valley, Minnesota.',
         ...
         'In England, the Speaker of the House is not allowed to speak', 'Earthworms have 5 hearts',
         ...
         'To make an espresso 42 coffee beans are needed', 'The oil that is found in poison ivy is called "urushiol."',
         ...
         'The New Zealand Kiwi bird cannot fly', '66% of wedding cards are hand delivered by people',
         ...
         'The first Ford cars had Dodge engines', 'The average height of an NBA basketball player is 6 feet 7 inches',
         'One in five Americans move homes every year', 'The chocolate chip cookie was invented in 1933',
         'The capital of Burkina Faso is Ouagadougou', 'A catfish has about 100,000 taste buds',
         ...
         'The odds of having quadruplets are 1 in 729,000', 'In 1965, the price for an issue of TV Guide was 15 cents',
         ...
         'Astronauts get taller when they are in space', 'Only 5 to 10 percent of cheetah cubs make it to adulthood',
         ...
         'The U.S. paid Russia $7.2 million for Alaska in 1867', 'Cows can detect odors up to five miles away',
         ...
         'Women smile more than men do', 'A ripe cranberry will bounce. Another name for a cranberry is bounceberry',
         ...
         'The flu pandemic of 1918 killed over 20 million people', 'Approximately 20% of Americans have a passport',
         ...
         'It is impossible to sneeze with your eyes open', 'People still cut the cheese shortly after death',
         ...
         'Every year approximately 3,000 people choke to death', 'Cow is a Japanese brand of shaving foam',
         ...
         'There are more plastic flamingos in America than real ones', 'Walt Disney had a fear of mice',
         ...
         'Nutmeg is extremely poisonous if injected intravenously', 'The average Super Bowl party has 18 people',
         'An ant can detect a movement through 5 centimeters of earth', 'One out of 200 women is colorblind',
         'On average, the rainfall across the Amazon is 7 feet annually.',
         'Passion fruits have a tranquilizing effect on the body',
         'It is physically impossible for pigs to look up into the sky', 'A snail can sleep for 3 years',
         ...
         'Spotted skunks do handstands before they spray', 'A dime has 118 ridges around the edge',
         ...
         'Queen Victoria used marijuana, to help relieve menstrual cramp pain', 'On a ship a toilet is called a head',
         ...
         'A blink lasts approximately 0.3 seconds', 'In 1903 Mary Anderson invented the windshield wipers',
         'Both Thomas Jefferson and Jimmy Carter, U.S. presidents, were peanut farmers at one time',
         'A cow releases about 125 gallons of gas per day', 'The Apollo 17 crew were the last men on the moon',
         ...
         'The act of sneezing is referred to as sternutation', 'The average medium size piano has about 230 strings',
         ...
         'In a lifetime, an average man will shave 20,000 times', 'The Pentagon has 284 restrooms',
         ...
         "A duck's quack doesn't echo, and no one knows why", 'Caterpillar means "hairy cat" in Old French',
         ...
         'The giant squid has the largest eyes in the world', "Elephants can't jump. Every other mammal can.",
         ...
         'Brazil produces the most oranges in the world', 'Average life span of a major league baseball: 7 pitches.',
         'The eyeball of a human weighs approximately 28 grams',
         'A human head remains conscious for about 15 to 20 seconds after it is been decapitated',
         'Witchcraft means "Craft of the Wise Ones."', '500,000 kids in the US live in same sex households',
         ...
         'The feet have approximately 250,000 sweat glands', 'Approximately 7.5% of all office documents get lost',
         ...
         'There were 13 couples celebrating their honeymoon on the Titanic', 'A cat has 32 muscles in each ear',
         ...
         'The sport of surfing originated in Hawaii', 'It is possible to lead a cow upstairs...but not downstairs',
         ...
         'Two out of five people end up marrying their first love', 'The Hawaiian alphabet only has 12 letters',
         ...
         'On average, pigs live for about 15 years', 'Roughly 42% of people in the United Kingdom snore',
         ...
         'Baby robins eat 14 feet of earthworms every day', 'Every three seconds a baby is born somewhere in the world',
         ...
         'In the U.S. peanuts account for 66% of all snack nuts', 'There are approximately 7,000 feathers on an eagle',
         ...
         'The longest town name in the world has 167 letters', 'A sneeze zooms out of your mouth at over 600 m.p.h',
         ...
         'Every 40,000 children are killed by fires', 'The highest recorded speed of a sneeze is 165 km per hour',
         ...
         'In a year, an average person uses the toilet 2500 times a year', 'A honey bee has four wings',
         ...
         'Polar bears are left handed', 'Food can only be tasted if it is mixed with saliva',
         ...
         'In the United States, about 33% of land is covered by forests', 'Lemons contain more sugar than strawberries',
         ...
         'In a year, Americans eat approximately 20 billion pickles', 'Althaiophobia is the fear of marshmallows',
         ...
         'The blackberry bush is also called the "bramble."', 'The city of Tokyo was originally called Edo',
         ...
         'Bill Gates began programming computers at age 13', 'Tobacco contains over 50 chemicals that can cause cancer',
         ...
         '66% of home based businesses are owned by women', 'There are approximately 60 muscles in the face',
         ...
         'There was no punctuation until the 15th century', 'All babies are colour blind when they are born',
         ...
         'The word assassination was invented by William Shakespeare', 'Benjamin Franklin invented the rocking chair.',
         ...
         'The eye of a human can distinguish 500 shades of the gray', 'There is a town in Norway called "Hell"',
         'Most heart attacks occur between the hours of 8 and 9 am', 'No one in Greece has memorized all 158 verses',
         ...
         'A chicken is 75% water', 'If you keep a Goldfish in the dark room, it will eventually turn white',
         ...
         'Mr. Rogers is an ordained minister', 'Between 12%-15% of the population is left-handed',
         'When a polar bear cub is born, it can not see or hear. It takes approximately a month for the cub to start to see and hear',
         'Girls have more tastebud than boys', 'Dandelion root can be roasted and ground as a coffee substitute',
         ...
         'The name Reebok was named after the African Gazelle', 'The average human scalp has 100,000 hairs',
         ...
         'Hitler and Napolean both had only one testical', 'The largest bill U.S. bill made is for $100,000',
         ...
         'From all the vegetables, beets contain the most sugar', 'Smelling bananas can help a person lose weight',
         ...
         'Talc was used by cavemen 15,000 years ago as an ingredient added to make paint', 'Ants do not sleep',
         ...
         'In every episode of Seinfeld there is a Superman somewhere.', 'The human heart weighs less than a pound',
         ...
         'Mexican jumping beans jump because of moth larvae inside the bean', 'Women blink nearly twice as much as men',
         ...
         'There are more pigs than humans in Denmark', 'A human eyeball weighs an ounce',
         ...
         'The DNA of humans is closer to a rat than a cat', 'Peladophobia refers to the fear of bald people',
         'One Neptune year lasts 165 Earth years', 'In the U.S., 75% of the pencils sold are painted yellow',
         ...
         'On average a business document is copied 19 times', 'Pigeons can see ultraviolet lights',
         ...
         'A crocodile can run up to a speed of 11 miles per hour', 'Fried spiders taste like nuts',
         ...
         '215 jeans can be made with one bale of cotton', 'Hawaiian alphabet has 12 letters',
         ...
         'Thomas Edison was afraid of the dark', 'Thailand used to be called Siam',
         'A sneeze can travel as fast as one hundred miles per hour', 'The Pentagon cost $49,600,000 to build in 1941',
         ...
         'The official state mammal of Texas is the armadillo', 'The word Himalayas means the "home of snow."',
         ...
         'A myrmecologist studies ants', 'Rice is thrown at weddings as a symbol of fertility',
         'More than 90% of shark attack victims survive', 'The average temperature on Earth is 15 degrees celcius.',
         ...
         'In some parts of the Atacama Desert it has never rained', 'In 1681, the last dodo bird died',
         ...
         'Polar bears can smell seals who are 20 miles away', 'Hair is made from the same substance as fingernails',
         ...
         'Shakespeare invented the word "assassination" and "bump."', 'A diet high in fat is said to impede memory',
         ...
         'The heart of an adult giraffe weighs on average 26 pounds', 'Two million red blood cells die every second',
         ...
         'In Ireland, a prime minister is a called a Taoiseach', 'American President John Tyler had 15 children',
         ...
         'Uranus is the only planet that rotates on its side', 'The peanut is not a nut, it is actually a legume',
         ...
         'Over 40 million Americans have chronic bad breath', 'There are 158 verses in the Greek National Anthem',
         ...
         'Owen Falls Lake is the largest man-made lake in the world', 'The patent number of the telephone is 174465.',
         ...
         'All penguins live south of the equator', 'There are more than 640 muscles in the human body',
         ...
         'The tallest mammal in the world is the giraffe', 'Obsessive nose picking is referred to as rhinotillexomania',
         ...
         'A honey bee has four wings', 'Badminton originates from a sport in India called "poona."',
         ...
         'In the United States, turkeys are mostly raised in California', 'The only state to grow pineapples is Hawaii',
         ...
         'On September 7, 1997, the first flight of the F-22a occurred.', 'There are five years in a quinquennium',
         'The average life span of a mosquito is two weeks',
         'Eating 11 pounds of apples will make you gain one pound of weight', 'Slugs have 4 noses',
         ...
         'Eyebrow hair lasts between 3-5 months before it sheds', 'An elephant cannot jump',
         ...
         'The makers of Crayola produce over 2 billion crayons in a year', 'The human face is made up of 14 bones',
         ...
         'In one day, a queen bee can lay up to 1500 eggs in one day', '"Pomology" is the science of growing an apple',
         ...
         'The kidneys filter over 400 gallons of blood each day', 'Another word to refer to old age is senectitude',
         ...
         'Fear of clowns is called coulrophobia', 'The average person is about a quarter of an inch taller at night',
         ...
         'There is a Hamburger hall of fame in Seymour, Wisconsin', 'The Olympic torch weighs about 3 pounds',
         ...
         'Polar bears are left-handed', 'Brain damage will only occur if a fever goes above 107.6 degrees farenheit',
         ...
         'Did you know that there are coffee flavored PEZ?', 'An individual coral animal is called a polyp',
         ...
         '"Kemo Sabe" means "soggy shrub" in Navajo', '7 out of 10 people believe in life after death',
         ...
         'The best selling chocolate syrup in the world is Hershey', 'The word Karate means, "empty hand."',
         ...
         'In 2002, the most popular boat name in the U.S. was Liberty', 'One out of 20 people have an extra rib',
         ...
         'There are six million parts in the Boeing 747-400.', 'The first TONKA truck was made in 1947',
         ...
         'Chinese Crested dogs can get acne', 'It costs about 3 cents to make a $1 bill in the United States',
         ...
         'The nickname for a Japanese businessmen is "Salarymen."', 'Emus cannot walk backwards',
         ...
         'Annually Americans eat 45 million turkeys at Thanksgiving', 'Rabbits can live up to ten years',
         ...
         'Isaac Newton used to be a member of parliament', 'Dumbest Dog: Afghan hound',
         ...
         'The Basenji dog is the only dog that is not able to bark', 'There is a dog museum in St. Louis, Missouri',
         'The tip of a bullwhip moves so fast that it breaks the sound barrier. The crack of the whip is actually a tiny sonic boom.',
         'There is a city called Smackover located in Arkansas', 'An average person laughs about 15 times a day',
         ...
         'A baseball will go farther in hot temperature than in cold temperature', 'A rabbit is not able to vomit',
         ...
         'In 1893, the first mosque in the United States was built', 'Apples are part of the rose family',
         ...
         'Enamel is hardest substance in the human body', 'A leech has 32 brains',
         ...
         'In a lifetime, an average human produces 10,000 gallons of saliva', 'A slug has four noses',
         ...
         'Camel is considered unclean meat in the Bible', 'Soldier Field is the oldest field in the NFL',
         'In the U.S., over one million gallons of cosmetics, drinks, and lotions are sold that contain aloe in them per year',
         'The name Jeep came from the abbreviation used in the army for the"General Purpose" vehicle, G.P.',
         'Eating eight strawberries will provide you with more Vitamin C than an orange',
         'The first toilet ever seen on television was on "Leave It To Beaver".', 'Mosquitoes have teeth',
         ...
         'Lions cannot roar until they reach the age of two.', 'A baby kangaroo is called a joey',
         ...
         'There is cyanide in apple pips', 'True spiders always have organs for spinning silk known as spinnerets',
         ...
         'In an year, an average American kid eats 46 slices of pizza', 'In Las Vegas, casinos do not have any clocks',
         ...
         'A penguin swims at a speed of approximately 15 miles per hour', 'The word Thailand means "land of the free."',
         ...
         'Chopsticks originated from China approximately 4,000 years ago', 'The favorite honeymoon place is Hawaii',
         ...
         'Stalks of sugar cane can reach up to 30 feet', 'The markings that are found on dice are called "pips."',
         ...
         'Chewing gum has rubber as an ingredient', 'An orca whale can hold its breath for up to 15 minutes',
         ...
         'Research on pigs led to the development of CAT scans.', 'The Hundred Years War lasted for 116 years',
         ...
         'One billion seconds is about 32 years', 'An average American eats approximately 60 hot dogs per year',
         ...
         'The state of Tennessee was known as Franklin before 1796', 'Over 90% of poison exposures occur in homes',
         ...
         'The WD in WD-40 stands for Water Displacer', 'Lachanophobia is the fear of vegetables',
         ...
         'India has the most post offices in the world', 'Women take three times longer than men when using the toilet',
         ...
         '1 out of every 4 kids in the USA is overweight', '"Kemo Sabe" means "soggy shrub" in Navajo',
         ...
         'The first Tupperware item marketed was the seven-ounce bathroom cup in 1945', 'Sharks are immune to cancer',
         ...
         'Turtles can breathe through their butts', 'A pregnant goldfish is called a twit',
         'The name Wendy was made up for the book "Peter Pan."',
         ...
         'A honey bee has four wings', 'Chedder cheese is the best selling cheese in the USA',
         ...
         'The majority of cats do not have any eyelashes', 'Reindeer like to eat bananas',
         ...
         'The name Wendy was made up for the book "Peter Pan."', 'Another word for hiccups is "singultus."',
         ...
         'A cat has 32 muscles in each ear', 'In one gram of soil, about ten million bacteria live in it',
         'When Alexander Graham Bell invented the telephone back in 1876, only six phones were sold in the first month.',
         'Americans eat approximately 20 pounds of pasta per person each year', 'Dolphins sleep with one eye open',
         ...
         'Ninety percent of the population has an innie belly button', 'The fear of Halloween is called Samhainophobia',
         ...
         'There are coffee flavored PEZ', 'Half of the 42 U.S. Presidents are of Irish descent',
         ...
         '111,111,111 x 111,111,111 = 12,345,678,987,654,321', 'Each Jelly Belly jelly belly bean has 4 calories',
         ...
         'Krispy Kreme make five million doughnut a day', 'The only real person to be a Pez head was Betsy Ross',
         'There were no red colored M&Ms from 1976 to 1987', 'In 1681, the last dodo bird died',
         ...
         'From 1939 to 1942, there was a undersea post office in the Bahamas', 'An owl has three eyelids',
         ...
         'Buckingham Palace has over six hundred rooms', 'Male owls weigh less and are smaller than female owls',
         ...
         'There are over 200 parts in a typical telephone', 'There is an automobile model called Stutz Bearcat.',
